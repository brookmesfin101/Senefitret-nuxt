<template>
  <section id="articles" class="mt-4">
      ...
      <div class="articles-container row">
        <RecentArticle :thumbnail="'/images/ManuscriptPics/Sep11Flowers.png'" :title="'The Ethiopian New Year and September 11'" :format="'md'" 
        ...
        <RecentArticle :thumbnail="'/images/ManuscriptPics/generic_ethiopia_landscape_1.jpg'" :title="'Neglected Treasure'" :format="'md'"  
        ...
        <RecentArticle :thumbnail="'/images/ManuscriptPics/Addis_Buildings/1950-1960_Addis_Buildings_html_59f3899b4d864fdb.gif'" :title="'1950 1960 Addis Buildings'" :format="'md'" 
                        :subtitle="'አበባ ዋና ዋና ሕንጻዎች እንዴት እና በማን...'" :crop="'0px 0px 0px 0px'" v-on:openManuscript="openManuscript($event)"/>   
        <RecentArticle :thumbnail="'/images/ManuscriptPics/Wubishet_Worq_Alemahu_html_dd77b29fd12ddb4d.gif'" :title="'Wubishet Worq Alemahu'" :format="'md'" 
