<template>  
      <div class='row no-gutters'>
        <div id="LoginPanel" class='col-3 mt-5 offset-3 bg-white'>
          ...
          <div class='pl-4 pr-4 mb-5'>
            ...
            <div class="form-inline border-bottom">
              ...
              <input class='form-control border-0' type='text' placeholder='Type your username'/>
            </div>
            <p class='mb-0 mt-3'>Password</p>
            <div class="form-inline border-bottom">
              <font-awesome-icon :icon="['fas', 'lock']" class="fa-fw border-bottom'"/>
              <input class='form-control border-0' type='password' placeholder='Type your password'/>
            </div>
            <p class='text-right text-dark'>Forgot password?</p>
            <button class='btn btn-success btn-block mb-4 mt-5' type='button'>Login</button>
          </div>          
        </div>
      </div>
</template>
